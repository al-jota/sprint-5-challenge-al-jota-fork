...
//   const [apiMentors, apiLearners] = await Promise.all([
//     axios.get('http://localhost:3003/api/mentors'),
//     axios.get('http://localhost:3003/api/learners')
//   ]);

//   let mentors = [apiMentors.data];
//   let learners = [apiLearners.data];

//   console.log("Data from API mentors", mentors);
//   console.log("Data from API learners", learners);
// } catch (error) {
...
let learnersData = learners.data;
  ...
  // const newLearners = learners.mentors.map(learnersID => {
  //   const correspondingID = mentors.id.find(mentorsID => mentorsID.id === learnersID.mentors);

  //   if (correspondingID) {
  //     return {
  //       ...learnersID,
  //       id: correspondingID.firstName
  //     };
  //   } else {
  //     return learnersID;
  //   }
  ...
  // console.log("Data from API mentors:", mentors);
  // console.log("Data from API learners with IDs replaced by full names:", newLearners);
